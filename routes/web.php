...
Route::prefix('admin')->name('orderform.')->middleware('auth')->group(function () {
    ...
    Route::get('/orderform/create/{id?}', [OrderFormController::class, 'createview'])->name('create');
...
//Image Category function Master
Route::prefix('admin')->name('ImageCategory.')->middleware('auth')->group(function () {
    Route::get('ImageCategory/index', [ImageCategoryController::class, 'index'])->name('index');
    Route::post('/ImageCategory/store', [ImageCategoryController::class, 'store'])->name('store');
    Route::get('/ImageCategory/edit/{id?}', [ImageCategoryController::class, 'editview'])->name('edit');
    Route::post('/ImageCategory/update', [ImageCategoryController::class, 'update'])->name('update');
    Route::delete('/ImageCategory/delete', [ImageCategoryController::class, 'delete'])->name('delete');
    Route::get('ImageCategory/AddImageindex', [ImageCategoryController::class, 'Add_Image_index'])->name('AddImageindex');
    Route::post('/ImageCategory/Imagestore', [ImageCategoryController::class, 'Image_store'])->name('Imagestore');
    Route::delete('/image/delete', [ImageCategoryController::class, 'image_delete'])->name('imagedelete');
     Route::any('ImageCategory/mydata', [ImageCategoryController::class, 'my_image_data'])->name('Mydata');
});
