            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('customerfunction.index', $id) }}"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('customerfunction.store') }}" method="POST"
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-lg-3 col-md-4">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" maxlength="50"
                                                    ...
                                                    value="{{ old('strFunction') }}" required>
                                                @error('strFunction')
                                        ...
                                        <div class="col-lg-2 col-md-4">
                                            <div>
                                                ...
                                                <input type="date" class="form-control" placeholder="Enter Date"
                                                    name="strDate" autocomplete="off" value="{{ old('strDate') }}" required>
                                                @error('strDate')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-2 col-md-4">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" maxlength="4" minlength="1"
                                                    ...
                                                    autocomplete="off" value="{{ old('iNoOfPerosn') }}" required>
                                                @error('iNoOfPerosn')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-2 col-md-4">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" maxlength="5" minlength="1"
                                                    ...
                                                    autocomplete="off" value="{{ old('iRatePerPerson') }}" required>
                                        ...
                                        <div class="col-lg-3 col-md-4">
                                            <div>
                                                ...
                                                <input type="text" readonly class="form-control" maxlength="5"
                                                    ...
                                                    autocomplete="off" value="{{ old('iTotalAmount') }}" required>
                                                @error('iTotalAmount')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-3 col-md-4">
                                            <div>
                                                ...
                                                <textarea class="form-control" placeholder="Enter Location" name="strLocation" autocomplete="off" required>{{ old('strLocation') }}</textarea>
                                                @error('strLocation')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
