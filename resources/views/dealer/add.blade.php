                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <form method="POST" onsubmit="return validateFile()"
                                        action="{{ route('dealer.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" name="strEmail"
                                                        ...
                                                        maxlength="30" value="{{ old('strEmail') }}">
                                                </div>
                                                @error('strEmail')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div>
                                                        ...
                                                        <input type="text" class="form-control" name="address1"
                                                            ...
                                                            autocomplete="off" value="{{ old('address1') }}">
                                                    </div>
                                                    @error('address1')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" name="pincode"
                                                        ...
                                                        required autocomplete="off" value="{{ old('pincode') }}">
                                                </div>
                                                @error('pincode')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
