            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form id="user-delete-form" method="POST" action="{{ route('productinquiry.delete') }}">
                            @csrf
                            @method('DELETE')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light p-3">
                    <h5 class="modal-title">Product Inquiry Detail </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        ...
                        <div class="col-lg-12">
                            <table width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center" style="width: 20%;text-align: justify;padding: 5px;">Product
                                            Name
                                        </td>
                                        <td class="text-center" id="showproductname"></td>
                                    </tr>

                                    <tr>
                                        <td class="text-center" style="width: 20%;text-align: justify;padding: 5px;">
                                            Location
                                        </td>
                                        <td class="text-center" id="showlocationname"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" id="showMessage"
                                            style="text-align: justify !important;padding: 2px 17px 2px 11px;">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
@section('scripts')
    <script>
        ...
        function viewData(id) {
            var url = "{{ route('productinquiry.viewdetail', ':id') }}";
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#showproductname").html(obj.productid);
                        $("#showlocationname").html(obj.location);
