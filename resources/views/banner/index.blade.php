                                            ...
                                            <form method="POST" action="{{ route('banner.store') }}"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-4 mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="iSequenceNo"
                                                            onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                                            autocomplete="off" maxlength="1"
                                                            placeholder="Enter Sequence No" required autofocus>
                                                    </div>

                                                    <div class="mb-3">
                                                        <span style="color:red;">*</span>Photo
                                                        <input type="file" class="form-control" name="strPhoto"
                                                            id="photovalidate" autocomplete="off" required autofocus>
                                                    </div>
                                                    <div id="viewimg">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($datas as $data)
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <a href="https://navdeepproducts.com/Banner/<?php echo $data->strPhoto; ?>"
                                                                target="_blank" class="mx-1">
                                                                <img src="{{ asset('Banner/') . '/' . $data->strPhoto }}"
                                                                    alt="" width="50px" height="50px">
                                                            </a>
                                                        </td>
                                                        <td>{{ $data->iSequenceNo ?? '-' }}</td>
                                                        <td>
                                                            <div class="gap-2">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <button type="button" class="btn w-sm btn-success mx-2"
