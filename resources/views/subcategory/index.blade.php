                                                    ...
                                                    <div class="mt-4 mb-3">
                                                        <div>
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="subcategoryname" placeholder="Enter Sub Category Name"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($SubCategory as $subcategory)
                                                            <tr class="text-center">
                                                                <td>{{ $i + $SubCategory->perPage() * ($SubCategory->currentPage() - 1) }}
                                                                <td>{{ $subcategory->categoryname }}</td>
                                                                <td>{{ $subcategory->subcategoryname }}</td>

                                                                <td>
                                                                    <?php if($subcategory->photo){ ?>
                                                                    <a target="_blank"
                                                                        href="{{ asset('SubCategory') . '/' . $subcategory->photo }}">
                                                                        <img src="{{ asset('SubCategory') . '/' . $subcategory->photo }}"
                                                                ...
                                                                <td>{{ $subcategory->strSequenceNo }}</td>
                                                                <td>
                                                                    <div class="d-flex gap-2">
                                                                        <a class="mx-1" title="Edit" href="#"
                                                                            onclick="getEditData(<?= $subcategory->sub_categoryId ?>)"
                                                                        ...
                                                                        <a class="" href="#"
                                                                            ...
                                                                            onclick="deleteimage(<?= $subcategory->sub_categoryId ?>);">
                                                                        ...
                                                                        <a class="" href="#"
                                                                            ...
                                                                            onclick="deleteData(<?= $subcategory->sub_categoryId ?>);">
        ...
        <div class="modal fade flip" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" onsubmit="return EditvalidateFile()" action="{{ route('subcategory.update') }}"
                        autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="sub_categoryId" id="sub_categoryId" value="">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <span style="color:red;">*</span>Category Name
                                <select type="text" class="form-control" name="categoryId" id="EditcategoryId"
                                    autocomplete="off" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="subcategoryname"
                                    id="Editsubcategoryname" placeholder="Enter Sub Category Name" maxlength="30"
                                    autocomplete="off" required>
                        ...
                        <div class="modal-footer">
                            <div class="hstack gap-2 justify-content-end">
                                ...
                                <a class="btn btn-primary float-right mr-3"
                                        href="{{ route('subcategory.index') }}">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                            ...
                            <form id="user-delete-form-imagedelete" method="POST"
                                action="{{ route('subcategory.imagedelete') }}">
                                @csrf
                                @method('post')
                                <input type="hidden" name="sub_categoryId" id="deleteimageid" value="">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                            ...
                            <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                            <form id="user-delete-form" method="POST" action="{{ route('subcategory.delete') }}">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="sub_categoryId" id="deleteid" value="">
                                <input type="hidden" name="page" id="currentPage" value="{{ request('page', 1) }}">
